...
[![npm version](https://img.shields.io/npm/v/tigeropen.svg)](https://www.npmjs.com/package/tigeropen)
...
```typescript
import { PushClient } from 'tigeropen/push/push-client';
...
- [npm 包主页](https://www.npmjs.com/package/tigeropen)
